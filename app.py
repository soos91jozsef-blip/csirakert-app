...
with st.form("rendeles_form"):
    ...
    termek2 = st.selectbox("Termék", ["Retek Mix", "Brokkoli", "Búzafű", "Vajrépa", "Lucerna", "Repce", "Vöröslencse", "Mungóbab", "Szendvics Mix", "Lila Karalábé", "Fodros Kel", "Vöröshere", "Vöröskáposzta"])
